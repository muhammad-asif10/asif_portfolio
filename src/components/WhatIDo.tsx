        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Transforming raw data into meaningful insights through cleaning, processing, and advanced visualization techniques.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building and deploying machine learning models for classification, regression, and NLP tasks using state-of-the-art libraries.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
